...
public class Estudiante {
    ...
    public Estudiante(String fechaRegistroPersona, String lng, String lat, String apellidos, String nombres, String cedula, int edad, String sexo, String celular, String telFijo, String correo, int numPersonasHogar, String alguienPresentaSintomas, String estudiantePresentaSintomas, int cantidadPersonasSintomas, String contactoPersonaConCovid, String usuario) {
